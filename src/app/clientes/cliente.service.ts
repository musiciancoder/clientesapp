...
export class ClienteService {
  ...
  constructor(private http: HttpClient, private router: Router,
              private authservice: AuthService) { //INYECCION DE DEPENDENCIAS, CON ESTO http: HttpClient queda definida como atributo de la clase

  }

  private agregarAuthorizationService() {
  ...
  getRegiones(): Observable<Region[]> {
    return this.http.get<Region[]>(this.urlEndPoint + '/regiones', {headers: this.agregarAuthorizationService()}).pipe(
      catchError(e => {
  ...
  create(cliente: Cliente): Observable<Cliente> {
    return this.http.post(this.urlEndPoint, cliente, {headers: this.agregarAuthorizationService()}).pipe(
  ...
  getCliente(id): Observable<Cliente> {
    ...
    return this.http.get<Cliente>(`${this.urlEndPoint}/${id}`, {headers: this.agregarAuthorizationService()}).pipe(
      catchError(e => {
  ...
  update(cliente: Cliente): Observable<any> {
    return this.http.put<any>(`${this.urlEndPoint}/${cliente.id}`, cliente, {headers: this.agregarAuthorizationService()}).pipe(
      catchError(e => {
  ...
  delete(id: number): Observable<Cliente> {
    return this.http.delete<Cliente>(`${this.urlEndPoint}/${id}`, {headers: this.agregarAuthorizationService()}).pipe(
      catchError(e => {
